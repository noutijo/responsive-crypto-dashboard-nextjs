  ...
  return (
    <>
      <aside
        ...
        <button className="lg:hidden w-[3rem] h-[3rem] absolute top-2 right-2 z-[6]" onClick={closeAsideBarMenu}>
          <i className="bi bi-x text-3xl"> </i>
        </button>

        <div>
          {/** get and list all asidebar menu items */}
